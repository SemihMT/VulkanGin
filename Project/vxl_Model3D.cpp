...
namespace vxl
{
	std::vector<VkVertexInputBindingDescription> vxlModel3D::Vertex3D::GetBindingDescriptions()
	{
	...
	std::vector<VkVertexInputAttributeDescription> vxlModel3D::Vertex3D::GetAttributeDescriptions()
	{
	...
	vxlModel3D::vxlModel3D(vxlDevice& device, const std::vector<Vertex3D>& vertices, const std::vector<uint32_t>& indices) :
		m_device{ device }
	{
	...
	void vxlModel3D::CreateVertexBuffers(const std::vector<Vertex3D>& vertices)
	{
	...
	void vxlModel3D::CreateIndexBuffers(const std::vector<uint32_t>& indices)
	{
	...
	void vxlModel3D::Bind(VkCommandBuffer commandBuffer)
	{
	...
	void vxlModel3D::Draw(VkCommandBuffer commandBuffer)
	{
